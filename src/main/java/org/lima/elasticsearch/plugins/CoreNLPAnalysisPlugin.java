...
import org.lima.elasticsearch.index.analysis.CoreNLPTokenizerFactory;
import org.lima.elasticsearch.tokenizer.CoreNLPTokenizer;


public class CoreNLPAnalysisPlugin extends Plugin implements AnalysisPlugin {

	@Override
    public Map<String, AnalysisModule.AnalysisProvider<TokenizerFactory>> getTokenizers() {

        Map<String, AnalysisModule.AnalysisProvider<TokenizerFactory>> extraTokenizer = new HashMap<>();
        extraTokenizer.put(CoreNLPTokenizer.name, new AnalysisModule.AnalysisProvider<TokenizerFactory>() {
			@Override
			public TokenizerFactory get(IndexSettings indexSettings, Environment environment, String name,
				...
				return new CoreNLPTokenizerFactory(indexSettings, name, settings, pluginPath);
			}
        });
